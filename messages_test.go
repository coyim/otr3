...
func Test_dataMsgSignWithSerializeUnsignedCache(t *testing.T) {
	...
	m.sign(macKey)
	assertDeepEquals(t, m.authenticator, [20]byte{0x6f, 0x6, 0x76, 0x45, 0xbb, 0x94, 0x5c, 0xa2, 0xfc, 0x13, 0xa9, 0xfa, 0x58, 0xb7, 0xd7, 0x23, 0xee, 0xab, 0x62, 0xe8})
}
...
func Test_dataMsgSignWithoutSerializeUnsignedCache(t *testing.T) {
	...
	macKey := macKey{0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03}
	m.sign(macKey)
	assertDeepEquals(t, m.serializeUnsignedCache, []byte{0x0, 0x0, 0x3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x0, 0x0, 0x0, 0x4, 0x0, 0x1, 0x2, 0x3})
	assertDeepEquals(t, m.authenticator, [20]byte{0x6f, 0x6, 0x76, 0x45, 0xbb, 0x94, 0x5c, 0xa2, 0xfc, 0x13, 0xa9, 0xfa, 0x58, 0xb7, 0xd7, 0x23, 0xee, 0xab, 0x62, 0xe8})
}
...
func Test_dataMsgCheckSignWithoutError(t *testing.T) {
	m := dataMsg{
		serializeUnsignedCache: []byte{0x0, 0x0, 0x3, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x1, 0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7, 0x0, 0x0, 0x0, 0x4, 0x0, 0x1, 0x2, 0x3},
		authenticator:          [20]byte{0x6f, 0x6, 0x76, 0x45, 0xbb, 0x94, 0x5c, 0xa2, 0xfc, 0x13, 0xa9, 0xfa, 0x58, 0xb7, 0xd7, 0x23, 0xee, 0xab, 0x62, 0xe8},
	}
	macKey := macKey{0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03}
	assertDeepEquals(t, m.checkSign(macKey), nil)
}
...
func Test_dataMsgCheckSignWithError(t *testing.T) {
	...
	macKey := macKey{0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03}
	assertDeepEquals(t, m.checkSign(macKey).Error(), "otr: bad authenticator MAC in data message")
}
...
func Test_dataMsgDeserialze(t *testing.T) {
	...
	authenticator := [20]byte{0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x02, 0x03}
	oldMACKeys := []macKey{
...
func Test_dataMsgDeserialzeErrorWhenCorruptedRevealMACKeyEnding(t *testing.T) {
	...
	revKeys = append(revKeys, oldMACKeys[1][:sha1.Size-1]...)
	msg = appendData(msg, revKeys)
