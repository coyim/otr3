...
func Test_dataMsgSignWithoutSerializeUnsignedCache(t *testing.T) {
	...
	assertDeepEquals(t, m.authenticator, [20]byte{0x36, 0x84, 0x4d, 0x5d, 0x5, 0xe7, 0x88, 0xd3, 0x46, 0x90, 0x27, 0xe4, 0x2, 0x7e, 0x2b, 0x6b, 0x10, 0x7b, 0xdd, 0x79})
}
...
func Test_encrypt_EncryptsPlainMessageUsingSendingAESKeyAndCounter(t *testing.T) {
	...
	encrypted := plain.encrypt(sendingAESKey)
