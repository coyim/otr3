...
func Test_verifySMP3Parameters_failsIfPaIsNotInTheGroupForProtocolV3(t *testing.T) {
	otr := context{otrV3{}, fixtureRand()}
	err := otr.verifySMP3Parameters(fixtureMessage1(), smpMessage3{pa: big.NewInt(1)})
...
func Test_verifySMP3Parameters_failsIfQaIsNotInTheGroupForProtocolV3(t *testing.T) {
	otr := context{otrV3{}, fixtureRand()}
	err := otr.verifySMP3Parameters(fixtureMessage1(), smpMessage3{
		pa: big.NewInt(2),
		qa: big.NewInt(1),
	})
...
func Test_verifySMP3Parameters_failsIfCpIsNotAValidZKP(t *testing.T) {
	...
	err := otr.verifySMP3Parameters(fixtureMessage1(), m)
	assertDeepEquals(t, err, errors.New("cP is not a valid zero knowledge proof"))
}
...
func Test_verifySMP4Parameters_succeedsForValidZKPS(t *testing.T) {
	otr := context{otrV3{}, fixtureRand()}
	err := otr.verifySMP4Parameters(fixtureMessage2(), fixtureMessage3(), fixtureMessage4())
	assertDeepEquals(t, err, nil)
}

func Test_verifySMP4Parameters_failsIfRbIsNotInTheGroupForProtocolV3(t *testing.T) {
	otr := context{otrV3{}, fixtureRand()}
	err := otr.verifySMP4Parameters(fixtureMessage2(), fixtureMessage3(), smpMessage4{rb: big.NewInt(1)})
...
func Test_verifySMP4Parameters_failsIfCrIsNotACorrectZKP(t *testing.T) {
	...
	m := fixtureMessage4()
	m.cr = sub(m.cr, big.NewInt(1))
	err := otr.verifySMP4Parameters(fixtureMessage2(), fixtureMessage3(), m)
	assertDeepEquals(t, err, errors.New("cR is not a valid zero knowledge proof"))
}
