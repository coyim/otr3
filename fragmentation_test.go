...
func Test_fragment_returnsNoChangeForASmallerPackage(t *testing.T) {
	...
	assertDeepEquals(t, ctx.fragment(data, 13, defaultInstanceTag, defaultInstanceTag), []MessageFragment{data})
}
...
func Test_fragment_returnsFragmentsForNeededFragmentation(t *testing.T) {
	...
	assertDeepEquals(t, ctx.fragment(data, 4, defaultInstanceTag, defaultInstanceTag+2), []MessageFragment{
...
func Test_fragment_returnsFragmentsForNeededFragmentationForV2(t *testing.T) {
	...
	assertDeepEquals(t, ctx.fragment(data, 4, defaultInstanceTag, defaultInstanceTag+1), []MessageFragment{
