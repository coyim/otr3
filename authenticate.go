...
func (c *Conversation) StartAuthenticate(question string, mutualSecret []byte) (FragmentedMessage, error) {
...
func (c *Conversation) ProvideAuthenticationSecret(mutualSecret []byte) (FragmentedMessage, error) {
