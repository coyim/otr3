...
func (c *Conversation) StartAuthenticate(question string, mutualSecret []byte) ([]MessageFragment, error) {
...
func (c *Conversation) ProvideAuthenticationSecret(mutualSecret []byte) ([]MessageFragment, error) {
