...
func (c *conversation) generateSMP1Parameters() (s smp1, ok bool) {
...
func generateSMP1Message(s smp1) (m smpMessage1) {
...
func (c *conversation) generateSMP1() (s smp1, ok bool) {
...
func (c *conversation) verifySMP1(msg smpMessage1) error {
