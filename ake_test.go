...
func init() {
	...
	publicKeyB, _ = hex.DecodeString("")

	publicKeyA, _ = hex.DecodeString("")
}
...
func TestRevealSigMessage(t *testing.T) {
	...
	result := ake.RevealSigMessage(publicKeyB)
	assertDeepEquals(t, result, out)
}
...
func TestSigMessage(t *testing.T) {
	...
	out = append(out, expectedEncryptedSignature...)
	out = append(out, expedctedMACSignature[:20]...)
	result := ake.SigMessage(publicKeyA)
	assertDeepEquals(t, result, out)
}
...
func Test_generateRevealKeyEncryptedSignature(t *testing.T) {
	...
	encryptedSig := ake.generateEncryptedSignature(&ake.revealKey, true, publicKeyB)
...
func Test_generateSigKeyEncryptedSignature(t *testing.T) {
	...
	encryptedSig := ake.generateEncryptedSignature(&ake.sigKey, false, publicKeyA)
...
func Test_generateVerifyData(t *testing.T) {
	...
	verifyData := ake.generateVerifyData(publicKeyB, true)
