...
var (
	fixed_r                  = bytesFromHex("abcdabcdabcdabcdabcdabcdabcdabcd")
	fixed_x                  = bnFromHex("bbcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd")
	fixed_y                  = bnFromHex("abcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcdabcd")
	fixed_gx                 = bnFromHex("")
	fixed_gy                 = bnFromHex("")
...
func Test_dhCommitMessage(t *testing.T) {
	var ake AKE
	ake.Rand = fixedRand([]string{hex.EncodeToString(fixed_x.Bytes()), hex.EncodeToString(fixed_r[:])})
...
func Test_encrypt(t *testing.T) {
	var ake AKE
	ake.otrVersion = otrV3{}
	ake.Rand = fixedRand([]string{hex.EncodeToString(fixed_x.Bytes())})
	ake.gx = fixed_gx
...
func Test_hashedGx(t *testing.T) {
	hashedGx := sha256Sum(fixed_gx.Bytes())
	assertDeepEquals(t, hashedGx, expectedHashedGxValue)
}

func Test_checkDecryptedGxWithoutError(t *testing.T) {
	var ake AKE
	copy(ake.digest[:], sha256Sum(appendMPI([]byte{}, fixed_gx)))
	err := ake.checkDecryptedGx(appendMPI([]byte{}, fixed_gx))
	assertDeepEquals(t, err, nil)
}

func Test_checkDecryptedGxWithError(t *testing.T) {
	var ake AKE
	copy(ake.digest[:], sha256Sum(appendMPI([]byte{}, fixed_gy)))
	err := ake.checkDecryptedGx(appendMPI([]byte{}, fixed_gx))
